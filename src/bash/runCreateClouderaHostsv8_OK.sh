...
ssh ${C2NNHOST} sysctl vm.swappiness=10
ssh ${C1DN1HOST} sysctl vm.swappiness=10
ssh ${C1DN2HOST} sysctl vm.swappiness=10
ssh ${C1DN3HOST} sysctl vm.swappiness=10
ssh ${C1DN4HOST} sysctl vm.swappiness=10
...
--ip 177.10.10.10 \
--ulimit memlock=-1 --memory-swappiness=10 \
