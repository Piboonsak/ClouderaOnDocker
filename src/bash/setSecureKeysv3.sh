...
## hd-c1nn
docker exec -it hd-c1nn service ssh start && service apache2 start
RESULT_C1NN="$(docker exec -it hd-c1nn service ssh status)"
echo "$HOSTNAME : ${RESULT_C1NN}"

## hd-c2nn
ssh docker101 'docker exec -i hd-c2nn service ssh start && service apache2 start'
...
## hd-c1dn1
ssh docker102 'docker exec -i hd-c1dn1 service ssh start && service apache2 start'
...
## hd-c1dn2
ssh docker105 'docker exec -i hd-c1dn2 service ssh start && service apache2 start'
...
## hd-c1dn3
ssh docker106 'docker exec -i hd-c1dn3 service ssh start && service apache2 start'
...
## hd-c1dn4
ssh docker107 'docker exec -i hd-c1dn4 service ssh start && service apache2 start'
