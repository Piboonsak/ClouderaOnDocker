...
#Pull image
IMAGE=$(echo "piboonsak/ubuntu:cloudera")
IMAGEDB=$(echo "piboonsak/ubuntu:mysqlv5.7.23")
docker pull ${IMAGE}
docker pull ${IMAGEDB}
...
--network ${NETWORK} --hostname ${C1NN} -l namenode \
--ip 177.10.10.10 \
...
--network ${NETWORK} --hostname ${C2NN} -l namenode \
--ip 177.10.10.11 \
--ulimit memlock=-1 --memory-swappiness=0 --privileged \
--restart=unless-stopped --sig-proxy=true \
-p 2022:22 -p 81:80 -p 88:88 -p 111:111 -p 4443:443 -p 1004:1004 -p 1006:1006 \
...
--network ${NETWORK} --hostname ${C1DN1} -l datanode \
--ip 177.10.10.12 \
--ulimit memlock=-1 --memory-swappiness=0 --privileged \
--restart=unless-stopped --sig-proxy=true \
-p 2022:22 -p 81:80 -p 88:88 -p 111:111 -p 4443:443 -p 1004:1004 -p 1006:1006 \
...
--network ${NETWORK} --hostname  ${C1DN2} -l datanode \
--ip 177.10.10.13 \
--ulimit memlock=-1 --memory-swappiness=0 --privileged \
--restart=unless-stopped --sig-proxy=true \
-p 2022:22 -p 81:80 -p 88:88 -p 111:111 -p 4443:443 -p 1004:1004 -p 1006:1006 \
...
--network ${NETWORK} --hostname ${C1DN3} -l datanode \
--ip 177.10.10.14 \
--ulimit memlock=-1 --memory-swappiness=0 --privileged \
--restart=unless-stopped --sig-proxy=true \
-p 2022:22 -p 81:80 -p 88:88 -p 111:111 -p 4443:443 -p 1004:1004 -p 1006:1006 \
...
--network ${NETWORK} --hostname ${C1DN4} -l datanode \
--ip 177.10.10.15 \
--ulimit memlock=-1 --memory-swappiness=0 --privileged \
--restart=unless-stopped --sig-proxy=true \
-p 2022:22 -p 81:80 -p 88:88 -p 111:111 -p 4443:443 -p 1004:1004 -p 1006:1006 \
...
--network ${NETWORK} --hostname ${DBCDH} \
--ip 177.10.10.205 \
