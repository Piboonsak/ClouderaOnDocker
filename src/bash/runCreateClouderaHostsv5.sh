...
ssh docker101 mkdir -p /hadoop
ssh docker101 chmod 777 /hadoop
ssh docker101 ls -alh /hadoop

ssh docker102 mkdir -p /hadoop
ssh docker102 chmod 777 /hadoop
ssh docker102 ls -alh /hadoop

ssh docker105 mkdir -p /hadoop
ssh docker105 chmod 777 /hadoop
ssh docker105 ls -alh /hadoop

ssh docker106 mkdir -p /hadoop
ssh docker106 chmod 777 /hadoop
ssh docker106 ls -alh /hadoop

ssh docker107 mkdir -p /hadoop
ssh docker107 chmod 777 /hadoop
ssh docker107 ls -alh /hadoop
...
echo "Create clodera hosts v5 complete!"
